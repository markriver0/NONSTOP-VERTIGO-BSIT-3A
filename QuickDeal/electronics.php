...
//         WHERE LOWER(categories.name) = 'electronics' 
//           AND items.status = 'Available'";

// if ($subcategory) {
//     $sql .= " AND LOWER(subcategory.name) = '" . mysqli_real_escape_string($conn, $subcategory) . "'";
// }
...
<head>
  ...
  <title>Quickie Deal - Electronics</title>
...
<section class="section-1">
  ...
  <h1>Quickie Deal <br><span> Electronics </span></h1>
...
<button class="next" onclick="changeSlide(1)">&#10095;</button>
  ...
  <section class="products-section">
   <div class="flex-spacearound">
      <h1 style="font-size: 4rem;">Electronics</h1>

      <div class="filter-bar">
      <form method="get" action="electronics.php" style="display: flex; align-items: center;">
        <?php if ($subcategory): ?>
...
<h2>Browse by Category</h2>
  ...
  <div class="category-card">
    <a href="electronics.php?subcategory=Phones">
    <img src="https://cdn-icons-png.flaticon.com/128/2482/2482945.png" alt="Accessories">
      <p>Phones</p>
    </a>
  </div>

  <div class="category-card">
    <a href="electronics.php?subcategory=Computers">
      <img src="https://cdn-icons-png.flaticon.com/128/771/771298.png" alt="Accessories">
      <p>Computers</p>
    </a>
  </div>

  <div class="category-card">
    <a href="electronics.php?subcategory=Accessories">
      <img src="https://cdn-icons-png.flaticon.com/128/1260/1260333.png" alt="Accessories">
      <p>Accessories</p>
    </a>
  </div>

  <div class="category-card">
    <a href="electronics.php?subcategory=Laptops">
      <img src="https://cdn-icons-png.flaticon.com/128/428/428001.png" alt="Laptops">
      <p>Laptops</p>
    </a>
  </div>

  <div class="category-card">
    <a href="electronics.php?subcategory=Monitors">
      <img src="https://cdn-icons-png.flaticon.com/128/2933/2933245.png" alt="Monitors">
      <p>Monitors</p>
    </a>
  </div>

  <div class="category-card">
    <a href="electronics.php?subcategory=Networking">
      <img src="https://cdn-icons-png.flaticon.com/128/2099/2099193.png" alt="Networking">
      <p>Networking</p>
    </a>
  </div>

  <div class="category-card">
    <a href="electronics.php?subcategory=PC Gaming">
      <img src="https://cdn-icons-png.flaticon.com/128/3612/3612569.png" alt="PC Gaming">
      <p>PC Gaming</p>
    </a>
  </div>
...
<?php if ($subcategory): ?>
  <h2 style="margin-left: 2rem;">Showing: <?= htmlspecialchars(ucfirst($subcategory)) ?></h2>
<?php endif; ?>
    ...
    <?php if (mysqli_num_rows($result) > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p style="color: red; font-size: 1.2rem; margin-top: 2rem;">No products found in the Electronics category.</p>
    <?php endif; ?>
    </div>
