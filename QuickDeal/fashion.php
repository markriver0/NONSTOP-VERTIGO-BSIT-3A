...
$sql = "SELECT items.* 
        ...
        WHERE LOWER(categories.name) = 'fashion' 
...
<head>
  ...
  <title>Quickie Deal - Fashion</title>
...
<section class="tagline-section">
  ...
  <h1>Quickie Deal <br><span> Fashion </span></h1>
...
<div class="flex-spacearound">
      <h1 style="font-size: 4rem;">Fashion</h1>
...
<h2>Browse by Category</h2>
  ...
  <a href="fashion.php?subcategory=womens">
    <img src="https://cdn-icons-png.flaticon.com/128/3220/3220315.png" alt="Womens">
    <p>Womens</p>
  </a>
</div>

<div class="category-card">
  <a href="fashion.php?subcategory=mens">
    <img src="https://cdn-icons-png.flaticon.com/128/265/265674.png" alt="Mens">
    <p>Mens</p>
  </a>
</div>

<div class="category-card">
  <a href="fashion.php?subcategory=kids">
    <img src="https://cdn-icons-png.flaticon.com/128/9136/9136536.png" alt="Kids">
    <p>Kids</p>
  </a>
</div>

<div class="category-card">
  <a href="fashion.php?subcategory=footwear">
    <img src="https://cdn-icons-png.flaticon.com/128/1940/1940912.png" alt="Footwear">
    <p>Footwear</p>
  </a>
</div>

<div class="category-card">
  <a href="fashion.php?subcategory=accessories">
    <img src="https://cdn-icons-png.flaticon.com/128/2599/2599226.png" alt="Accessories">
    <p>Accessories</p>
  </a>
</div>

<div class="category-card">
  <a href="fashion.php?subcategory=unisex">
    <img src="https://cdn-icons-png.flaticon.com/128/1415/1415499.png" alt="Unisex">
    <p>Unisex</p>
  </a>
</div>
  </div>
...
<?php endif; ?>
    ...
    <?php if (mysqli_num_rows($result) > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p style="color: red; font-size: 1.2rem; margin-top: 2rem;">No products found in the Fashion category.</p>
    <?php endif; ?>
    </div>
