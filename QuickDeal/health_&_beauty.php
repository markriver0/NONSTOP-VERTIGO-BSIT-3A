...
$sql = "SELECT items.* 
        ...
        WHERE LOWER(categories.name) = 'health & beauty' 
...
<head>
  ...
  <title>Quickie Deal - Health & Beauty</title>
  <link rel="stylesheet" href="health_beauty.css">
...
<section class="tagline-section">
  ...
  <h1>Quickie Deal <br><span> Health & Beauty </span></h1>
...
<div class="flex-spacearound">
      <h1 style="font-size: 4rem;">Health & Beauty</h1>

      <div class="filter-bar">
      <form method="get" action="heath_&_beauty.php" style="display: flex; align-items: center;">
        <?php if ($subcategory): ?>
...
<h2>Browse by Category</h2>
  ...
  <a href="health_&_beauty.php?subcategory=Skincare">
    <img src="https://cdn-icons-png.flaticon.com/128/2763/2763410.png" alt="Skincare">
    <p>Skincare</p>
  </a>
</div>

<div class="category-card">
  <a href="health_&_beauty.php?subcategory=Beauty">
    <img src="https://cdn-icons-png.flaticon.com/128/2828/2828304.png" alt="Beauty">
    <p>Beauty</p>
  </a>
</div>

<div class="category-card">
  <a href="health_&_beauty.php?subcategory=Health">
    <img src="https://cdn-icons-png.flaticon.com/128/2966/2966486.png" alt="Health">
    <p>Health</p>
  </a>
</div>

<div class="category-card">
  <a href="health_&_beauty.php?subcategory=Hygiene Essentials">
    <img src="https://cdn-icons-png.flaticon.com/128/3183/3183186.png" alt="Hygiene Essentials">
    <p>Hygiene Essentials</p>
  </a>
</div>

<div class="category-card">
  <a href="health_&_beauty.php?subcategory=Personal Care">
    <img src="https://cdn-icons-png.flaticon.com/128/3057/3057396.png" alt="Personal Care">
    <p>Personal Care</p>
  </a>
</div>

<div class="category-card">
  <a href="health_&_beauty.php?subcategory=Hair Care">
    <img src="https://cdn-icons-png.flaticon.com/128/7206/7206187.png" alt="Hair Care">
    <p>Hair Care</p>
  </a>
</div>
...
<?php endif; ?>
    ...
    <?php if (mysqli_num_rows($result) > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p style="color: red; font-size: 1.2rem; margin-top: 2rem;">No products found in the Health and Beauty category.</p>
    <?php endif; ?>
    </div>
